%% Formulate dimensional two-track prediction model
...
function [] = FormulatePredictionModel(VEHICLE, CONST)
...
matlabFunction(DfDx,DfDu,'file','Codegen/PredictionModelJacobian','vars',{xi,u,deltaf});
disp('Writing state dynamics to a function')
matlabFunction([f;u;deltaf],'file','Codegen/PredictionModel','vars',{Ts,[xi;u;deltaf]});
disp('Done')
end