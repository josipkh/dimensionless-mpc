%% Formulate dimensionless two-track prediction model
function [] = FormulatePredictionModelPi(VEHICLE, CONST)
...
matlabFunction(DfpDxip,DfpDup,'file','Codegen/PredictionModelPiJacobian','vars',{xip,up,deltaf});
disp('Writing state dynamics to a function')
matlabFunction([fp;up;deltaf],'file','Codegen/PredictionModelPi','vars',{Ts,[xip;up;deltaf]});
disp('Done')
end